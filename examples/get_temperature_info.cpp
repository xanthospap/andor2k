...
int main() {
  ...
  if (ac_triggermode_continuous)
    printf("AC_TRIGGERMODE_CONTINUOUS is available!\n");
  else
    printf("AC_TRIGGERMODE_CONTINUOUS not available for this camera!\n");
  ...
  if (status == DRV_SUCCESS) {
    ...
    printf(
        "WTF! the function should not answer that way ..... possible ERROR\n");
  }
